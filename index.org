...
The dungeon rooms will come from the [[href:/x/2321-offgrid/][offgrid algorithm]] that Chris Cox sent me. It's only ~20 lines of code.

Last year I used thin walls. I think they were neat, especially helping with player-built rooms. I don't have player-built rooms this year. I'll go back to thick walls.
...
<x:footer>
  Created 26 Jun 2023; &#160;
  <!-- hhmts start -->Last modified: 10 Jul 2023<!-- hhmts end -->
</x:footer>
#+end_export
