...
Last year I made everything visible. This year though, I want the player to unlock rooms as you go through the game, so those rooms won't be visible until you open them up. The /doors/ between two rooms will be visible if /either/ of the rooms is visible.
...
<x:footer>
  Created 26 Jun 2023; &#160;
  <!-- hhmts start -->Last modified: 17 Jul 2023<!-- hhmts end -->
</x:footer>
#+end_export
